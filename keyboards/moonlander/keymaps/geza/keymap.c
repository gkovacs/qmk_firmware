...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    MO(2),          KC_LCTRL,       KC_RGUI,                        RGUI(KC_SPACE), KC_BSPACE,      KC_SPACE
  ),
  [1] = LAYOUT_moonlander(
    ...
    KC_LSHIFT,      KC_A,           KC_R,           KC_S,           KC_T,           KC_D,           KC_TAB,                                                                         KC_ENTER,       KC_H,           KC_N,           KC_E,           KC_I,           KC_O,           KC_QUOTE,       
    ...
    KC_TRANSPARENT, LM(4,MOD_LCTL), LM(4,MOD_RGUI),                 RGUI(KC_SPACE), KC_BSPACE,      KC_SPACE
  ),
  [2] = LAYOUT_moonlander(
    ...
    KC_TILD,        KC_TRANSPARENT, KC_TRANSPARENT, KC_UP,          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_LCBR,        KC_RCBR,        KC_LBRACKET,    KC_RBRACKET,    KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_HOME,        KC_LEFT,        KC_DOWN,        KC_RIGHT,       KC_END,         KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_LPRN,        KC_RPRN,        KC_LBRACKET,    KC_RBRACKET,    KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TILD,        KC_PLUS,        KC_UNDS,        KC_EQUAL,       KC_MINUS,                                       KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
